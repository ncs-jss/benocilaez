...
<div class="loader"><img src="zeal/images/Hamaraloader.gif">
	...
	<h4>AWESOMENESS LOADING</h4>
		<h5>BEST VIEWED ON <i class = "fa fa-desktop"></i></h5>
		...
		<div class="right-detail ">
			...
			<div id ="{{$details->event_id}}">
				...
				<div id ="{{$details->event_id}}"  style="display : none;">
					...
					{!!strip_tags(strip_tags(substr($details->event_description,1,-1)))!!}
					@if(isset($details->long_des) && $details->long_des != "")
					<h4>DESCRIPTION</h4>
					{!!strip_tags(substr($details->long_des,1,-1))!!}
					@endif
...
<div class="detail pio-details">
		...
		<div class=" cross-3">
					...
					<div class="head-detail">PLAY IT ON</div>
		...
		<div class="right-detail ">
			...
			<div id ="{{$details->event_id}}">
				...
				<div id ="{{$details->event_id}}"  style="display : none;">
					...
					<?php $i++;?>
					<h4>{{strtoupper($details->event_name)}}</h4>
					{!!strip_tags(substr($details->event_description,1,-1))!!}
					@if(isset($details->long_des) && $details->long_des != "")
					<h4>DESCRIPTION</h4>
					{!!strip_tags(substr($details->long_des,1,-1))!!}
					@endif
...
<div class="detail colo-details">
		...
		<div class=" cross-3">
					...
					<div class="head-detail">COLORALO</div>
<div class="left-nav">
...
<!-- team page============================= -->
	<div class="team">
		...
		<div class="header">
			...
			<h5 id="sub-header">MEET THE SUPERHEROES BEHIND !!</h5>
		</div>
				...
				<div class="tooltip tooltip-effect-2">
					...
					<span class="team-social-icons">
						...
						<a href="https://in.linkedin.com/in/siddharth-jain-67a020b8"  target="_blank">
							...
							<span class="tooltip-content"><br>MADE WITH <i class="fa fa-heart fa-2x"></i><br>WHILE DRINKING <i class="fa fa-beer fa-2x"></i></span>
						<div class="tooltip-shape">
							<svg viewBox="0 0 200 150" preserveAspectRatio="none">
								<polygon points="29.857,3.324 171.111,3.324 196.75,37.671 184.334,107.653 104.355,136.679 100,146.676 96.292,136.355 16.312,107.653 3.25,37.671"/>
							</svg>
				...
				<div class="tooltip tooltip-effect-2">
					...
					<span class="team-social-icons">
						...
						<a href="https://in.linkedin.com/in/nelabhkotiya"  target="_blank">
							...
							<span class="tooltip-content"><br>MADE WITH <i class="fa fa-heart fa-2x"></i><br>WHILE PLAYING <i class="fa fa-gamepad fa-2x"></i></span>
						<div class="tooltip-shape">
							<svg viewBox="0 0 200 150" preserveAspectRatio="none">
								<polygon points="29.857,3.324 171.111,3.324 196.75,37.671 184.334,107.653 104.355,136.679 100,146.676 96.292,136.355 16.312,107.653 3.25,37.671"/>
							</svg>
	...
	<div class="base">
		...
		<header>
			<ul class="push-right social-icons">
				...
				<li>
					<a href="zeal/brochure.pdf" download title="Download Brochure"><i class="fa fa-download"></i></a>
				</li>
			</ul>
  ...
  ga('send', 'pageview');
									...
									<script type="text/javascript">
										...
										$('#a{{$details->event_id}}').click(function(){
											...
											@if($details->grp == $dummdetails->grp)
